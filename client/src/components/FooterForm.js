...
import { ProductContext, addProduct } from "../context/productContext";
...
const FooterForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    addProduct(dispatch, { title, price, quantity }, hideForm(e));
  };

  return (
    <div class="add-form">
      <p>
        <a onClick={displayForm} class="button add-product-button">
          Add A Product
        </a>
      </p>
      <h3>Add Product</h3>
      <form>
        ...
        <div class="actions form-actions">
          ...
          <a onClick={hideForm} class="button">
            Cancel
          </a>
        </div>
      </form>
